...
**Croc UI** è un'interfaccia grafica (GUI) moderna e intuitiva progettata per **[croc](https://github.com/schollz/croc)**, il potente strumento CLI che consente il trasferimento facile e sicuro di file e cartelle tra computer.

L'obiettivo principale di questo progetto è **semplificare lo scambio di file tra sistemi Windows e Linux**, eliminando la necessità di utilizzare il terminale o la riga di comando.

---

## ✨ Caratteristiche Principali

* **No Shell / Terminale:** Invia e ricevi file tramite un'interfaccia grafica intuitiva.
* **Cross-Platform:** Ottimizzata per garantire la massima compatibilità tra **Windows** e **Linux**.
...
1. Scarica l'ultima release dalla sezione [Releases](https://github.com/reverseloop-dev/Croc-UI-TuxLab/releases/tag/definitivo) (`.exe` per **Windows** o `.AppImage` per **Linux**).
